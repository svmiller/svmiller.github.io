...
### We Can Even Visualize These Findings With a Map
...
```{r}
#| eval=F
linloess_plot(M1, color="black", pch=21) # in {stevemisc}
```
...
show_ranef(M3, "region", reorder=FALSE) + theme_steve_web() +
  labs(caption = "Data: ?ESS9GB, in {stevedata}.",
       ...
       subtitle = "These will show which levels of the random effect start higher/lower than the global average and which effects are stronger/weaker than the global average.")
```
