...
knitr::opts_chunk$set(fig.path = fig_path, dev = 'svg',
                      cache.path = '../cache/rmd-non-academic-resume-template/',
...
add_jekyll_image('/images/rick-martel-crop.jpg', "You can read the pin, right?", "250", "right")
...
knitr::knit("_source/2020-09-01-rmarkdown-template-non-academic-resume.Rmd",
            output = "_posts/2020-09-01-rmarkdown-template-non-academic-resume.md")
