...
```{r setup-rmd-beamer, include=FALSE, cache=F}
...
knitr::opts_chunk$set(fig.path = fig_path, dev = 'svg',
                      cache.path = '../cache/another-rmd-article-template/',
...
add_jekyll_image('/images/new-rmd-article-template.png', "I did another thing. Here's what it looks like.", "500", "right")
...
```{r dont-sans-it-up, echo=F, eval=T, results="asis", cache=F}
 
add_jekyll_image('/images/dont-sans-it-up.png', "What it looks like when you don't sans it up.", "859", "center")
...
```{r sans-it-up, echo=F, eval=T, results="asis", cache=F}
 
add_jekyll_image('/images/sans-it-up.png', "What it looks like when you decide to sans it up.", "869", "center")
...
knitr::knit("_source/2020-09-11-another-rmarkdown-article-template.Rmd",
            output = "_posts/2020-09-11-another-rmarkdown-article-template.md")
