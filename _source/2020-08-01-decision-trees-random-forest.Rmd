...
```{r accuracy-predictions-trump-vote-other-states-2016, echo=F, eval=T, cache=T, warning=F, fig.width=13, fig.height = 12}
...
accuracyStates %>%
  ...
  labs(y = "Accuracy",
       ...
       subtitle = "Random forests and decision trees almost always do better than the null model (except in DC) and the random forest slightly outperforms the decision tree almost every time.",
