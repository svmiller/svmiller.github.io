...
knitr::opts_chunk$set(fig.path = fig_path, dev = 'svg',
                      cache.path = '../cache/strategic-rivalry/',
...
knitr::knit("2019-10-18-create-extend-strategic-rivalry-data-r.Rmd",
            output = "../_posts/2019-10-18-create-extend-strategic-rivalry-data-r.md")
```
