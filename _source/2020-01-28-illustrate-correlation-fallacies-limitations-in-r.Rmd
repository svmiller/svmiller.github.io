...
knitr::opts_chunk$set(fig.path = fig_path, dpi= 300,
                      cache.path = '../cache/correlation-limitations-fallacies/',
...
```{r anscombes-quartet-ggplot, echo=T, eval=T, cache=T, warning=F, fig.width=13, fig.height = 8}
...
knitr::knit("2020-01-28-illustrate-correlation-fallacies-limitations-in-r.Rmd",
            output = "../_posts/2020-01-28-illustrate-correlation-fallacies-limitations-in-r.md")
```
