...
```{r setup, include=FALSE, cache=T, cache.lazy=F}
...
```{r clean_gss7218, echo=T, eval=T, cache=T, warning=F}
GSS %>%
...
```{r gss7218-too-much-spending-health-care-social-security, echo=T, eval=T, cache=T, fig.width=14, fig.height=8, warning=F}
McCaskill %>%  
...
```{r gss7218-too-little-spending-health-care-social-security, echo=T, eval=T, cache=T, fig.width=14, fig.height=8, warning=F}
McCaskill %>%  
  group_by(regioncondensed, year) %>%
...
```{r gss7218-too-little-spending-health-care-social-security-midwest-pid, echo=T, eval=T, cache=T, fig.width=15, fig.height=8, warning=F}
McCaskill %>%  
