...
knitr::opts_chunk$set(fig.path = fig_path, dpi= 300,
                      cache.path = '~/Dropbox/svmiller.github.io/cache/ggplot-cal/',
...
add_jekyll_image('/images/ggplot-hex.png', "The ggplot hex logo", "240", "right")
...
```{r a-ggplot-calendar-example, echo=T, eval=T, cache=T, warning=F, fig.width=12, fig.height = 8}
...
knitr::knit("_source/2020-08-15-a-ggplot-calendar-for-your-semester.Rmd",
            output = "_posts/2020-08-15-a-ggplot-calendar-for-your-semester.md")
