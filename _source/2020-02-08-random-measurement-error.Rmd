...
```{r random-measurement-error-y, echo=F, eval=T, cache=T, warning=F, fig.width=12, fig.height = 8}
...
Ymods %>%
  ...
  labs(x = "Every 10th Observation of y is Recoded to This Value",
       ...
       subtitle = "Increasing random measurement error in y amounts trying to systematically model noise. There is little in the way of bias, plenty in the way of variance.",
       caption = "Shaded area communicates 95% Intervals from OLS with no measurement error.")
...
knitr::knit("2020-02-08-random-measurement-error.Rmd",
            output = "../_posts/2020-02-08-random-measurement-error.md")
```
