...
Data %>%
  ...
  mutate_if(is.numeric, ~round(., 2)) %>%
   kable(., format="html", table.attr='id="stevetable"',
        col.names=c("Date", "President", "DJIA (Close)", "DJIA (Close, Previous)", "% Change"),
        caption = "The 20 Worst 30-Day Rolling Windows in Dow Jones History, Feb. 16, 1885 to the Present",
        align=c("l","l","c","c","c","c"))
```
...
Data %>%
  ...
  mutate_if(is.numeric, ~round(., 2)) %>%
   kable(., format="html", table.attr='id="stevetable"',
        col.names=c("Date", "President", "DJIA (Close)", "DJIA (Close, Previous)", "% Change"),
        caption = "The 20 Best Trading Days in Dow Jones History, Feb. 16, 1885 to March 12, 2020",
        align=c("l","l","c","c","c","c"))
```
