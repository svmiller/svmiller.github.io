...
Cordata <- cor(Data)
rownames(Cordata) <- c("X","Treatment", "Instrument", "e")
colnames(Cordata) <- c("X","Treatment", "Instrument", "e")
...
M1 <- lm(y ~ x + treat, data=Data)

stargazer(M1, type="html",
          covariate.labels = c("X (Control)","Treatment"),
...
stargazer(M1, FSM, SSM, type="html",
          covariate.labels = c("X (Control)","Treatment", "Instrumental Variable", "Treatment (fitted values)"),
