...
```{r setup-us-terrorism-ideology, include=FALSE, cache=F}
...
knitr::opts_chunk$set(fig.path = fig_path,
                      cache.path = '../cache/us-terrorism-ideology',
...
```{r loadcleandata, cache=T, echo=F}
...
Ideo %>%
  ...
  kable(., format="html",
        ...
        caption = "The Number of Terror Attacks by Motviation in the 1970s",
        align=c("l","c"))
```
...
add_jekyll_image('/images/1975-fraunces-tavern-bombing.jpg', "Four people were killed and dozens were injured in the deadliest incident carried about by FALN. (Anonymous/ASSOCIATED PRESS)", "400", "right")
...
knitr::knit("2019-08-09-us-terrorism-ideology-analysis.Rmd",
            output = "../_posts/2019-08-09-us-terrorism-ideology-analysis-1970s.md")
```