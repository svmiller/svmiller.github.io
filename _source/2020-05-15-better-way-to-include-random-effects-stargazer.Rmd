...
knitr::opts_chunk$set(fig.path = fig_path, dpi= 300,
                      cache.path = '../cache/stargazing-random-effects-better-way/',
...
add_jekyll_image('/images/alma-observatory.jpg', "Stargazing on Scale (ALMA Observatory, Chile)", "400", "right")
...
stargazer(M1, M2, M2, type="html",
          ...
          dep.var.labels="Pro-Immigration Sentiment",
          model.names = FALSE,
          column.labels = c("OLS", "Linear Mixed Effects&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", "Linear Mixed Effects<br />(Bayesian)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
          )
...
knitr::knit("2020-05-15-better-way-to-include-random-effects-stargazer.Rmd",
            output = "../_posts/2020-05-15-better-way-to-include-random-effects-stargazer.md")
