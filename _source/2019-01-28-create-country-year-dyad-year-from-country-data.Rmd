...
```{r tabmecklenburgschwerin, echo=T, eval=T, cache=T, fig.width=13, fig.height=8, warning=F}
CY %>% filter(ccode == 280) %>%
  kable(., format="html",
...
```{r tabnigeriamongoliaddy, echo=T, eval=T, cache=T, fig.width=13, fig.height=8, warning=F}
...
```{r tabnigeriamongoliandy, echo=T, eval=T, cache=T, fig.width=13, fig.height=8, warning=F}
