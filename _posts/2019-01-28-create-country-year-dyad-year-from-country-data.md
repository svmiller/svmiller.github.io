...
The following code will create a simple country-year data frame that you can populate with country-year data of interest to you (e.g. civil war data, various IPE data). I'll annotate the code below so the reader can see what it's doing.
