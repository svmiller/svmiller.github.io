...
- **Github URLs just "look better"**. Finally, I think Github urls (i.e. `username.github.io`) just look nicer than other options. `yourusername.wordpress.com` looks like the subdomain of a blog, not an academic website. `sites.google.com/site/yourusername` is clunky. Students and colleagues will not remember it as easily. Plus, my hunch is Github doesn't nearly as many user accounts as Wordpress or Google. In other words, I got `svmiller` at Github when I joined on June 1, 2013. I highly doubt I could score something similar at Wordpress or Google. I would end up settling for something like `profsvmillerclemson`, which does not look nearly as nice. Plus, you can always [graft on your own particular domain name](https://help.github.com/articles/setting-up-a-custom-domain-with-github-pages/) to your Jekyll site on Github if you want.
