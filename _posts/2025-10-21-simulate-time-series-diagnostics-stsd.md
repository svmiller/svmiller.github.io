...
This is where one of the frustrating components of this procedure comes: the null hypothesis. This is one of those type of procedures. The null hypothesis here is clumsily stated as equivalent to "problem", in contrast with other diagnostic tests like Breusch-Pagan, Breusch-Godfrey, and Durbin-Watson (in which the null hypothesis is "no problem"). If the test statistic is less than ("more negative than") one of those critical values of your choice, you can reject the null hypothesis of "problem" (i.e. non-stationarity) and instead accept the alternative hypothesis of "no problem" (i.e. stationarity). If you cannot reject the null hypothesis, you have a problem. However, you're making a statement of compatibility or incompatibility of the null hypothesis referencing various distributions that are almost assuredly not your own.
