...
add_jekyll_image('/images/stockholm-university-sodra-hus.jpg', "I'm on the top floor of that building you see in the front (albeit on the other side). I can see Mark and Gonzalo's offices, though. (Photo: Clément Morin)", "400", "right")
```
