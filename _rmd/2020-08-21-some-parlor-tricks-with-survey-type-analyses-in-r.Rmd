...
```{r population-means-various-sample-types, echo=F, eval=T,  warning=F, fig.width=12, fig.height = 8}
popmeansBoot %>%
  group_by(method) %>%
...
```{r school-type-means-various-sample-types, echo=F, eval=T,  warning=F, fig.width=13, fig.height = 11}
fakeAPI %>%
  group_by(schooltype) %>%
...
```{r fakeapi-comparing-different-regression-models, echo=F, eval=T,  warning=F, fig.width=11.5, fig.height = 12}
regBootsums %>%
...
```{r api-comparing-different-regression-models, echo=F, eval=T,  warning=F, fig.width=12, fig.height = 12}
