...
# IGO <- haven::read_dta("~/Koofr/data/cow/igo/3/igo_year_format_3.dta")
# IGO %>%
...
add_jekyll_image('/images/bipm.jpeg', "Think the meter is kind of boring? It was the subject of an interesting political fight in the early 1900s about *when* something is a meter.", "350", "right")
```
...
```{r bar27, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/meter27.jpg', "The Meter Bar (National Prototype No. 27), as received by the United States in 1890", "300", "right")
```
