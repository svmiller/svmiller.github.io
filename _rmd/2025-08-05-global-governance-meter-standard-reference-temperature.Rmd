...
cowIGO %>%
  ...
  kbl(., longtable = TRUE, booktabs = TRUE,
      ...
      caption = "The First Ten IGOs in the Correlates of War IGO data (v. 3)",
      col.names = c("IGO (Abbr.)", "IGO Name", "Year Formed", "Last Year (2014 = Ongoing)")) %>%
...
```{r power-fra-gmy-gbr-usa-1875-1935, fig.width = 10.5}
cow_nmc %>%
