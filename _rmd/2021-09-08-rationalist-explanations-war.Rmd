...
Where $$k > 0$$ and $$p$$ follows [the rules of probability](https://stattrek.com/probability/probability-rules.aspx),  it is also the case that $$p + k \ge p - k$$ by definition. There exists, conceptually, a range of possible deals that A would offer and B would accept. Consider the graph below as illustrative.
