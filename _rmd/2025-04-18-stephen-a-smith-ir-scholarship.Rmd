...
add_jekyll_image('/images/stephen-a-smith-machiavelli.png', "I used to be proficient at Photoshop in a past life. It's just easier for ChatGPT to do this for me instead (because it did). It has that tell-tale filter after all.", "275", "right")
```
