...
add_jekyll_image('/images/2022-ukraine-grain-exports-crop.png', "The EU signed an emergency free trade agreement with Ukraine in 2022 that it extended in 2024. (Hassan Ammar/AP)", "400", "right")
```
...
```{r votebreakdown, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/2024-ukraine-free-trade-vote-snapshot.png', "A snapshot of the vote breakdown, by country.", "781", "center")
```
...
```{r snapshot, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/eu-ua-fta24-snapshot-2.png', "The spreadsheet I'm using", "722", "center")
```
...
```{r neighbif, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/neighb-if.png', "A convoluted extended 'IF' in Excel (or LibreOffice Calc)", "619", "center")
```
...
```{r voteif, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/vote-if.png', "A less convoluted extended 'IF' in Excel (or LibreOffice Calc)", "720", "center")
```
...
```{r matrix2x2, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/eu-ua-fta24-2x2.png', "A 2x2 Matrix", "439", "right")
```
...
```{r chi, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/eu-ua-fta24-chi.png', "A Chi-Square Test in Excel (LibreOffice Calc)", "309", "right")
```
...
```{r chidd, echo=F, eval=T, results="asis", cache=F}
add_jekyll_image('/images/eu-ua-fta24-chi-square-options.png', "Preparing a Chi-Square Test in Excel (LibreOffice Calc)", "519", "center")
```
