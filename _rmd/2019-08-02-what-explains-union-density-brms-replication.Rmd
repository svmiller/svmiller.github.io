...
posterior_samples(B0) %>%
  ...
  mutate(term = c("Industrial Concentration", "Intercept",
                  "Left Government", "Industrial Concentration")) %>%
  mutate(`Mean|Coef (SD|SE)` = paste0(estimate," (", std.error,")") )  %>%
  select(term, `Mean|Coef (SD|SE)`, lwr, upr) %>%
