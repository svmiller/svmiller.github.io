...
tidyB01 <- readRDS("~/Dropbox/svmiller.github.io/R/priors/tidyB01.rds")
m_sums <- readRDS("~/Dropbox/svmiller.github.io/R/priors/m_sums.rds")
...
```{r effect-various-priors-union-density, echo=F, eval=T, cache=F, warning=F, fig.width=12, fig.height = 8}
m_sums %>%
